...
router.post("/record_attendance", (req, res) => {
	const { date, time, employee_id, status } = req.body;
	const sql = `INSERT INTO attendance (date, time, employee_id, status) VALUES (?)`;
	const values = [date, time, employee_id, status];
